            ...
            <section id="form-section">
                <form action="resultado.php" method="post">
                    <div class="row row-gap-3 align-items-center">
                        <input id="tipo_operacao" name="tipo_operacao" type="hidden" value="deposito">
                        <label for="valor_formulario" name="valor_formulario" class="form-label">Informe o valor do depósito:</label>
                        ...
                        <div class="col-xs-12 col-sm-4 col-md-2">
                            <div class="d-grid">
                                <input class="btn btn-deposito btn-lg" type="submit" value="Depositar">
                            </div>
                        </div>
                    </div>
                </form>
