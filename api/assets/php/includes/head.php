...
<?php
    $url = 'https://meu-caixa-eletronico.vercel.app/api/';
    require "{$url}assets/php/Classes/Cliente.php";
    require "{$url}assets/php/Classes/Operacoes.php";
    require "{$url}assets/php/Classes/Relogio.php";
